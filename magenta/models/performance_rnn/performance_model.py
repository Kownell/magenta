...
default_configs = {
    ...
    'rerative_time_and_song_length_performance_with_dynamics':
        PerformanceRnnConfig(
            generator_pb2.GeneratorDetails(
                id='multiconditioned_performance_with_dynamics',
                description='Density- and pitch-conditioned Performance RNN'),
            ...
            global_condition=GlobalConditioning(csv='/media/oeda/HDCZ-UT1/data/dataset/tags/',tags=['感情分類'],song_bin=32,max_length=30)
            )
}
