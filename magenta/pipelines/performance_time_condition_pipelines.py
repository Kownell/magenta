...
class TimeEmbbedingPerformance(Performance):
  ...
  def __init__(self, quantized_sequence=None, steps_per_second=None,
    ...
    self.file_name = quantized_sequence.filename
...
# List of time embbeding signal classes.
all_time_embbeding_signals = [
    RelativeTimePerformanceControlSignal,
    AbsoluteTimePerformanceControlSignal
]
